            ...
            <div className="flex flex-wrap lg:flex-row-reverse">
                <div className="w-full lg:w-1/2">
                    <div className="flex justify-center lg:p-8">
                        <motion.img src={profilePic} alt="Bhanu Saisree Thanniru" className='border border-stone-900 rounded-3xl' width={650} height={650}
                ...
                <div className='w-full lg:w-1/2'>
                    <motion.div initial="hidden" animate="visible" variants={containerVariants} className='flex flex-col items-center lg:items-start mt-10'>
                        <motion.h2 variants={childVariants} className='pb-2 text-4xl tracking-tighter lg:text-8xl'>Bhanu Saisree Thanniru</motion.h2>
                        ...
                        <motion.a variants={childVariants} href='src/assets/projects/Bhanu_Saisree_Thanniru.pdf' target='_blank' rel='noopener noreferrer' download className='bg-white rounded-full p-4 text-sm text-stone-800 mb-10'>Download Resume</motion.a>
                    </motion.div>
                </div>
            </div>
        </div>
